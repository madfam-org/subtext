...
# Logs
enclii logs subtext-api --env prod -f                    # live tail
enclii logs subtext-api --env prod --since 1h -n 200     # last hour
...
# Rollback
enclii rollback subtext-api --env prod                   # previous release
enclii rollback subtext-api v42 --env prod

# Releases + deployment history
enclii releases subtext-api -n 20
...
enclii domains list --service subtext-api
enclii domains add my.example.com --service subtext-api   # auto-provisions tunnel route + DNS
